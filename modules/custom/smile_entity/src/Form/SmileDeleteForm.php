...
/**
 * Provides a form for deleting a smile_entity entity.
 *
 * @ingroup smile_entity
 */
class SmileDeleteForm extends ContentEntityConfirmFormBase {
   ...
   * {@inheritdoc}
   *
   * If the delete command is canceled, return to the smile list.
   */
